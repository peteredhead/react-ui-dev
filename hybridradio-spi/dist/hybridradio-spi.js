    ...
    _createClass(SI, [{
        ...
        value: function load() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                // TESTING
                var url = _this.url.replace('http://epg.musicradio.com', '/musicradio.php?p=');
                req.open('GET', url);
                ...
                req.onload = function () {
                    if (req.status == 200) {
                        ...
                        var groups = req.responseXML.groups;
...
var Bearer = function Bearer(id) {
    var cost = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
    var mimeValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
    var bitrate = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
    var offset = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
...
var GENRE_TYPE = exports.GENRE_TYPE = {
    MAIN: 0,
    SECONDARY: 1,
    OTHER: 2
};

var Genre = function Genre(href) {
    var typeString = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
var Link = function () {
    function Link(uri) {
        var mimeValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
        ...
        var expiryTime = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
        ...
        if (expiryTime === null) {
            ...
            this.expiryTime = (0, _moment2.default)(expiryTime);
        }
    }
...
var Multimedia = function Multimedia(url) {
    var lang = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
    var mimeValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
    var typeString = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
    var width = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
    var height = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : undefined;
...
var RadioDNS = function RadioDNS(fqdn, serviceIdentifier) {
    _classCallCheck(this, RadioDNS);
...
var _genre = __webpack_require__(119);
...
var _bearer = __webpack_require__(118);

var _bearer2 = _interopRequireDefault(_bearer);

var _multimedia = __webpack_require__(121);

var _multimedia2 = _interopRequireDefault(_multimedia);

var _radiodns = __webpack_require__(122);

var _radiodns2 = _interopRequireDefault(_radiodns);
...
var Service = function () {
    ...
    _createClass(Service, [{
        ...
        value: function fromXml(xml) {
            // Bearers
            var bearers = xml.getElementsByTagName("bearer");
            for (var i = 0; i < bearers.length; i++) {
                var b = bearers[i];
                var bearer = new _bearer2.default(b.id, b.cost, b.mimeValue, b.bitrate, b.offset);
            ...
            for (var i = 0; i < genres.length; i++) {
                var g = genres[i];
                var genre = new _genre2.default(g.getAttribute("href"), g.getAttribute("type"), g.textContent);
                this.genres.push(genre);
            }

            // Keywords
            var keywords = xml.getElementsByTagName("keywords");
            ...
            for (var i = 0; i < links.length; i++) {
                var l = links[i];
                var link = new _link2.default(l.getAttribute("uri"), l.getAttribute("mimeValue"), l.getAttribute("lang"), l.getAttribute("description"), l.getAttribute("expiryTime"));
                this.links.push(link);
            }

            // Short Name
            var shortName = xml.getElementsByTagName("shortName");
            ...
            // Medium Name
            var mediumName = xml.getElementsByTagName("mediumName");
            ...
            // Long Name
            var longName = xml.getElementsByTagName("longName");
            ...
            // Multimedia
            var multimediaz = xml.getElementsByTagName("multimedia");
            for (var i = 0; i < multimediaz.length; i++) {
                var m = multimediaz[i];
                var multimedia = new _multimedia2.default(m.getAttribute("url"), m.getAttribute("lang"), m.getAttribute("mimeValue"), m.getAttribute("type"), parseInt(m.getAttribute("width")), parseInt(m.getAttribute("height")));
                this.multimedia.push(multimedia);
            }

            // Short Description
            var shortDescription = xml.getElementsByTagName("shortDescription");
            if (shortDescription.length > 0) {
                if (shortDescription[0].childNodes !== undefined && shortDescription[0].childNodes.length > 0) {
                    var text = shortDescription[0].childNodes[0].textContent;
                    // Check length
                    if (text.length > 180) {
            ...
            // Long Description
            var longDescription = xml.getElementsByTagName("longDescription");
            if (longDescription.length > 0) {
                if (longDescription[0].childNodes !== undefined && longDescription[0].childNodes.length > 0) {
                    var _text = longDescription[0].childNodes[0].textContent;
                    // Check length
                    if (_text.length > 1200) {
                        console.warn("Long description exceeds the maximum length of 1200 characters");
                    } else {
                        this.longDescription = _text;
                    }
                }
            }

            // RadioDNS
            var radioDNS = xml.getElementsByTagName("radiodns");
            if (radioDNS.length > 0) {
                this.radioDNS = new _radiodns2.default(radioDNS[0].getAttribute("fqdn"), radioDNS[0].getAttribute("serviceIdentifier"));
            }

            // Service Group Member
            var serviceGroupMember = xml.getElementsByTagName("serviceGroupMember");
...
exports.PI = exports.SI = undefined;

var _si = __webpack_require__(117);

var _si2 = _interopRequireDefault(_si);

var _pi = __webpack_require__(116);

var _pi2 = _interopRequireDefault(_pi);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.SI = _si2.default;
exports.PI = _pi2.default;
